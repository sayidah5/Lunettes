        ...
        <div class="main-header">
          ...
          >
            <div class="container-fluid">
              ...
              >
              <h3 class="fw-bold mb-3" style="margin-top: 10%; font-size: 35px">Admin Lunettes</h3>
            ...
            >
              <div>
                <div class="container pt-5">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <a href="/produk/create" class="btn" style="background-color: #91ccd6; color:black" >Tambah Data</a><br>
                        </div>
                        <div class="col-md-6">
                            <form action="/search" method="post">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <button class="btn" type="submit" style="background-color: #91ccd6; color:black">Go</button>
                                </div>
                            </form>
                        </div>
                    </div>
                    ...
                    <table class="table" style="background-color: #91ccd6">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="/produk/delete/{{ $item->id }}" onclick="return window.confirm('Yakin hapus data ini?')" class="btn" style="background-color: #91ccd6 ;">Hapus</a>
